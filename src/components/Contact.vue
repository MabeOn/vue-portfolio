        ...
        <div
            ...
            <div class="flex flex-col gap-4 w-full items-center lg:items-start">
                ...
                <div class="flex gap-4">
                    <a href="https://github.com/mabeon" target="_blank" rel="noopener noreferrer" aria-label="Github">
                    ...
                    <a href="https://www.linkedin.com/in/mabeoff/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
